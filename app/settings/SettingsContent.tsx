    ...
    <div className="font-body-md text-body-md bg-[#050505] antialiased overflow-x-hidden min-h-screen flex selection:bg-primary-container selection:text-on-primary-container">
      ...
      <nav className="hidden md:flex flex-col h-screen py-8 bg-surface-container-lowest w-64 fixed left-0 top-0 border-r border-white/5 z-40">
        ...
        <ul className="flex-1 flex flex-col gap-1 mt-4">
          ...
          <li className="bg-secondary-container/20 text-primary border-r-4 border-primary rounded-r-xl py-3 px-8 flex items-center gap-4 cursor-pointer scale-[0.98] transition-all relative overflow-hidden group">
        ...
        <div className="px-8 mb-6 mt-auto">
          <Link href="/setup/topic" className="w-full py-3 px-4 bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 rounded-xl font-body-md text-body-md font-medium flex items-center justify-center gap-2 transition-colors">
